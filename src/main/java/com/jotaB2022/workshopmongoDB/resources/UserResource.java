...
import com.jotaB2022.workshopmongoDB.services.UserService;
...
public class UserResource {
	...
	@PutMapping(value="/{id}")
	public ResponseEntity<User> update(@RequestBody UserDTO obj, @PathVariable String id) {
	...
	public ResponseEntity<List<Post>> FindyPostinUser(@PathVariable String id) {
